...
const messages = [
    "Chúii ưi Lâm mún nói với chúi làaaaa",
    "Xin lũi Híp vì đã iu Híp nhìu hơn ngày hơn hôm quaaa",
    "Yêu Híp quãii, siu iu Híp, iu Híp với tình iu to bự siu tỏ khủng lồ",
    "Tình iu bự chà bá tổ chảng tản thần bự x1000000 bự hơn bà Tân Vê lócc",
    "Em có iu bản thăn khong, có thì làm tình (đ i c h) với Lâm nhóo",
    "Chúc cục cưng ngủ ngoannnn, mai mình chở đi chọc chóooa"
];
